...
describe('Notifications', () => {
	it('verifies that notification is valid when I use the id 5debd764a7c57c7839d722e9', () => {
		const notifications = [
			{
		...
		expect(allContext).toEqual(expect.arrayContaining(notifications));
	});

	it('verifies the normalized data has a correct result', () => {
		const data = [
	...
	it('verifies that the normalized data has a correct users', () => {
		const data = {
			age: 25,
	...
	it('verifies that the normalized data has a correct messages', () => {
		const data = {
	...
	it('verifies that the normalized data has a correct notifications', () => {
		const data = {
